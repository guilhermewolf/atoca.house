...
- [ ] All nodes connected to 192.168.40.0/24 network
- [ ] Network switch configured (if using managed switch)
- [ ] Static IP addresses reserved in DHCP:
  - [ ] 192.168.40.11 (node-01)
  - [ ] 192.168.40.12 (node-02)
  - [ ] 192.168.40.13 (node-03)
  - [ ] 192.168.60.10 (gateway LoadBalancer)
...
- [ ] etcd healthy:
  ...
  ```bash
  talosctl -n 192.168.40.201 etcd members
...
- [ ] Gateway LoadBalancer IP assigned: `192.168.40.210`
...
talosctl -n 192.168.40.201 etcd status
```
...
2. [ ] Capture logs:
   ...
   talosctl -n 192.168.40.201 logs > talos.log
   ```
