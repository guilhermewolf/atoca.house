...
- **`patches/node-01.yaml`** - Node-specific config (192.168.178.201)
- **`patches/node-02.yaml`** - Node-specific config (192.168.178.202)
- **`patches/node-03.yaml`** - Node-specific config (192.168.178.203)
...
```
┌─────────────┐
│ Control Plane│  192.168.178.201 (8GB)
└─────────────┘
       │
       └─────┬─────┬─────┐
             │     │     │
